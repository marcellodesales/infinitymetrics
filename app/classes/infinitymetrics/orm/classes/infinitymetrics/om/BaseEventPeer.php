...
abstract class BaseEventPeer {
	...
	const CLASS_DEFAULT = 'infinitymetrics.Event';
	...
	const JN_USERNAME = 'event.JN_USERNAME';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ChannelId', 'EventId', 'JnUsername', 'Date', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('channelId', 'eventId', 'jnUsername', 'date', ),
		BasePeer::TYPE_COLNAME => array (self::CHANNEL_ID, self::EVENT_ID, self::JN_USERNAME, self::DATE, ),
		BasePeer::TYPE_FIELDNAME => array ('channel_id', 'event_id', 'jn_username', 'date', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ChannelId' => 0, 'EventId' => 1, 'JnUsername' => 2, 'Date' => 3, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('channelId' => 0, 'eventId' => 1, 'jnUsername' => 2, 'date' => 3, ),
		BasePeer::TYPE_COLNAME => array (self::CHANNEL_ID => 0, self::EVENT_ID => 1, self::JN_USERNAME => 2, self::DATE => 3, ),
		BasePeer::TYPE_FIELDNAME => array ('channel_id' => 0, 'event_id' => 1, 'jn_username' => 2, 'date' => 3, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(EventPeer::CHANNEL_ID);

		$criteria->addSelectColumn(EventPeer::EVENT_ID);

		$criteria->addSelectColumn(EventPeer::JN_USERNAME);
	...
	public static function addInstanceToPool(Event $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getChannelId(), (string) $obj->getEventId()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Event) {
				$key = serialize(array((string) $value->getChannelId(), (string) $value->getEventId()));
	...
	public static function doCountJoinChannel(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(EventPeer::CHANNEL_ID,), array(ChannelPeer::CHANNEL_ID,), $join_behavior);
		$stmt = BasePeer::doCount($criteria, $con);
	...
	public static function doCountJoinUser(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(EventPeer::JN_USERNAME,), array(UserPeer::JN_USERNAME,), $join_behavior);
		$stmt = BasePeer::doCount($criteria, $con);
	...
	/**
	 * Selects a collection of Event objects pre-filled with their Channel objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinChannel(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
		...
		$c->addJoin(array(EventPeer::CHANNEL_ID,), array(ChannelPeer::CHANNEL_ID,), $join_behavior);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Event) to $obj2 (Channel)
				$obj2->addEvent($obj1);
	...
	public static function doSelectJoinUser(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(EventPeer::JN_USERNAME,), array(UserPeer::JN_USERNAME,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ChannelPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + (ChannelPeer::NUM_COLUMNS - ChannelPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Event) to the collection in $obj2 (Channel)
				$obj2->addEvent($obj1);
			...
			if ($key3 !== null) {
				...
				// Add the $obj1 (Event) to the collection in $obj3 (User)
				$obj3->addEvent($obj1);
			} // if joined row not null
	...
	/**
	 * Selects a collection of Event objects pre-filled with all related objects except Channel.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	 ...
	 *		 rethrown wrapped into a PropelException.
	 */
	public static function doSelectJoinAllExceptChannel(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		$c = clone $c;
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$comparison = $criteria->getComparison(EventPeer::CHANNEL_ID);
			$selectCriteria->add(EventPeer::CHANNEL_ID, $criteria->remove(EventPeer::CHANNEL_ID), $comparison);

			$comparison = $criteria->getComparison(EventPeer::EVENT_ID);
			$selectCriteria->add(EventPeer::EVENT_ID, $criteria->remove(EventPeer::EVENT_ID), $comparison);
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion = $criteria->getNewCriterion(EventPeer::CHANNEL_ID, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(EventPeer::EVENT_ID, $value[1]));
	 ...
	 * @return     Event
	 */
	public static function retrieveByPK($channel_id, $event_id, PropelPDO $con = null) {
		$key = serialize(array((string) $channel_id, (string) $event_id));
 		if (null !== ($obj = EventPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
		...
		$criteria->add(EventPeer::CHANNEL_ID, $channel_id);
		$criteria->add(EventPeer::EVENT_ID, $event_id);
