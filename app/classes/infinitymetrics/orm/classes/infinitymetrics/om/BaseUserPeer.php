...
abstract class BaseUserPeer {
	...
	const CLASS_DEFAULT = 'infinitymetrics.User';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('UserId', 'JnUsername', 'JnPassword', 'FirstName', 'LastName', 'Email', 'Type', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId', 'jnUsername', 'jnPassword', 'firstName', 'lastName', 'email', 'type', ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID, self::JN_USERNAME, self::JN_PASSWORD, self::FIRST_NAME, self::LAST_NAME, self::EMAIL, self::TYPE, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id', 'jn_username', 'jn_password', 'first_name', 'last_name', 'email', 'type', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('UserId' => 0, 'JnUsername' => 1, 'JnPassword' => 2, 'FirstName' => 3, 'LastName' => 4, 'Email' => 5, 'Type' => 6, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('userId' => 0, 'jnUsername' => 1, 'jnPassword' => 2, 'firstName' => 3, 'lastName' => 4, 'email' => 5, 'type' => 6, ),
		BasePeer::TYPE_COLNAME => array (self::USER_ID => 0, self::JN_USERNAME => 1, self::JN_PASSWORD => 2, self::FIRST_NAME => 3, self::LAST_NAME => 4, self::EMAIL => 5, self::TYPE => 6, ),
		BasePeer::TYPE_FIELDNAME => array ('user_id' => 0, 'jn_username' => 1, 'jn_password' => 2, 'first_name' => 3, 'last_name' => 4, 'email' => 5, 'type' => 6, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, 6, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(UserPeer::JN_USERNAME);

		$criteria->addSelectColumn(UserPeer::JN_PASSWORD);
	 ...
	 */
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		try {
			...
			// invalidate objects in WorkspacePeer instance pool, since one or more of them may be deleted by ON DELETE CASCADE rule.
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(EventPeer::JN_USERNAME, $obj->getJnUsername());
			$affectedRows += EventPeer::doDelete($c, $con);

			// delete related Instructors objects
			$c = new Criteria(InstructorsPeer::DATABASE_NAME);
			
			$c->add(InstructorsPeer::USER_ID, $obj->getUserId());
			$affectedRows += InstructorsPeer::doDelete($c, $con);

			// delete related Workspace objects
			$c = new Criteria(WorkspacePeer::DATABASE_NAME);
			
			$c->add(WorkspacePeer::USER_ID, $obj->getUserId());
			$affectedRows += WorkspacePeer::doDelete($c, $con);

			// delete related WorkspaceShare objects
			$c = new Criteria(WorkspaceSharePeer::DATABASE_NAME);
			
			$c->add(WorkspaceSharePeer::USER_ID, $obj->getUserId());
