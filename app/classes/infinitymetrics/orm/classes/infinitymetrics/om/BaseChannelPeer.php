...
abstract class BaseChannelPeer {
	...
	const CLASS_DEFAULT = 'infinitymetrics.Channel';
	...
	const PROJECT_JN_NAME = 'channel.PROJECT_JN_NAME';
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('ChannelId', 'ProjectJnName', 'ChannelName', 'Title', 'Category', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('channelId', 'projectJnName', 'channelName', 'title', 'category', ),
		BasePeer::TYPE_COLNAME => array (self::CHANNEL_ID, self::PROJECT_JN_NAME, self::CHANNEL_NAME, self::TITLE, self::CATEGORY, ),
		BasePeer::TYPE_FIELDNAME => array ('channel_id', 'project_jn_name', 'channel_name', 'title', 'category', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('ChannelId' => 0, 'ProjectJnName' => 1, 'ChannelName' => 2, 'Title' => 3, 'Category' => 4, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('channelId' => 0, 'projectJnName' => 1, 'channelName' => 2, 'title' => 3, 'category' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::CHANNEL_ID => 0, self::PROJECT_JN_NAME => 1, self::CHANNEL_NAME => 2, self::TITLE => 3, self::CATEGORY => 4, ),
		BasePeer::TYPE_FIELDNAME => array ('channel_id' => 0, 'project_jn_name' => 1, 'channel_name' => 2, 'title' => 3, 'category' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ChannelPeer::PROJECT_JN_NAME);

		$criteria->addSelectColumn(ChannelPeer::CHANNEL_NAME);

		$criteria->addSelectColumn(ChannelPeer::TITLE);

		$criteria->addSelectColumn(ChannelPeer::CATEGORY);
	...
	public static function addInstanceToPool(Channel $obj, $key = null)
	{
		if (Propel::isInstancePoolingEnabled()) {
			if ($key === null) {
				$key = serialize(array((string) $obj->getChannelId(), (string) $obj->getProjectJnName(), (string) $obj->getChannelName()));
			} // if key === null
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Channel) {
				$key = serialize(array((string) $value->getChannelId(), (string) $value->getProjectJnName(), (string) $value->getChannelName()));
	...
	public static function doCountJoinProject(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ChannelPeer::PROJECT_JN_NAME,), array(ProjectPeer::PROJECT_JN_NAME,), $join_behavior);
		$stmt = BasePeer::doCount($criteria, $con);
	...
	/**
	 * Selects a collection of Channel objects pre-filled with their Project objects.
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinProject(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$startcol = (ChannelPeer::NUM_COLUMNS - ChannelPeer::NUM_LAZY_LOAD_COLUMNS);
		ProjectPeer::addSelectColumns($c);

		$c->addJoin(array(ChannelPeer::PROJECT_JN_NAME,), array(ProjectPeer::PROJECT_JN_NAME,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = ChannelPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = ChannelPeer::getInstanceFromPool($key1))) {
				// We no longer rehydrate the object, since this can cause data loss.
				// See http://propel.phpdb.org/trac/ticket/509
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				ChannelPeer::addInstanceToPool($obj1, $key1);
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Channel) to $obj2 (Project)
	...
	/**
	 * Selects a collection of Channel objects pre-filled with all related objects.
	 *
	 * @param      Criteria  $c
	 * @param      PropelPDO $con
	 * @param      String    $join_behavior the type of joins to use, defaults to Criteria::LEFT_JOIN
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ChannelPeer::addSelectColumns($c);
		$startcol2 = (ChannelPeer::NUM_COLUMNS - ChannelPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			if ($key2 !== null) {
				...
				// Add the $obj1 (Channel) to the collection in $obj2 (Project)
				$obj2->addChannel($obj1);
	...
	public static function doUpdate($values, PropelPDO $con = null)
	{
		...
		if ($values instanceof Criteria) {
			...
			$selectCriteria->add(ChannelPeer::CHANNEL_ID, $criteria->remove(ChannelPeer::CHANNEL_ID), $comparison);

			$comparison = $criteria->getComparison(ChannelPeer::PROJECT_JN_NAME);
			$selectCriteria->add(ChannelPeer::PROJECT_JN_NAME, $criteria->remove(ChannelPeer::PROJECT_JN_NAME), $comparison);

			$comparison = $criteria->getComparison(ChannelPeer::CHANNEL_NAME);
			$selectCriteria->add(ChannelPeer::CHANNEL_NAME, $criteria->remove(ChannelPeer::CHANNEL_NAME), $comparison);
	...
	public static function doDeleteAll($con = null)
	{
		...
		try {
			...
			$con->beginTransaction();
			$affectedRows += ChannelPeer::doOnDeleteCascade(new Criteria(ChannelPeer::DATABASE_NAME), $con);
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion = $criteria->getNewCriterion(ChannelPeer::CHANNEL_ID, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(ChannelPeer::PROJECT_JN_NAME, $value[1]));
				$criterion->addAnd($criteria->getNewCriterion(ChannelPeer::CHANNEL_NAME, $value[2]));
				$criteria->addOr($criterion);

				// we can invalidate the cache for this single PK
				ChannelPeer::removeInstanceFromPool($value);
			}
		}
	...
	protected static function doOnDeleteCascade(Criteria $criteria, PropelPDO $con)
	{
		...
		foreach ($objects as $obj) {
			...
			$c->add(EventPeer::CHANNEL_ID, $obj->getChannelId());
			$affectedRows += EventPeer::doDelete($c, $con);
		}
		return $affectedRows;
	}
	 ...
	 * @return     Channel
	 */
	public static function retrieveByPK($channel_id, $project_jn_name, $channel_name, PropelPDO $con = null) {
		$key = serialize(array((string) $channel_id, (string) $project_jn_name, (string) $channel_name));
 		if (null !== ($obj = ChannelPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
		...
		$criteria->add(ChannelPeer::CHANNEL_ID, $channel_id);
		$criteria->add(ChannelPeer::PROJECT_JN_NAME, $project_jn_name);
		$criteria->add(ChannelPeer::CHANNEL_NAME, $channel_name);
