...
/**
 * This class adds structure of 'project' table to 'infinitymetricsm201' DatabaseMap object.
 *
 *
 *
...
class ProjectMapBuilder implements MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'infinitymetrics.map.ProjectMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addPrimaryKey('PROJECT_JN_NAME', 'ProjectJnName', 'VARCHAR', true, 50);
