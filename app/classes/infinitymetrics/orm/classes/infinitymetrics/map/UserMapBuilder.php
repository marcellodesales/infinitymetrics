...
/**
 * This class adds structure of 'user' table to 'infinitymetricsm201' DatabaseMap object.
 *
 *
 *
...
class UserMapBuilder implements MapBuilder {
	 ...
	 */
	const CLASS_NAME = 'infinitymetrics.map.UserMapBuilder';
	...
	public function doBuild()
	{
		...
		$tMap->addColumn('JN_USERNAME', 'JnUsername', 'VARCHAR', true, 32);

		$tMap->addColumn('JN_PASSWORD', 'JnPassword', 'VARCHAR', true, 32);
		...
		$tMap->addColumn('TYPE', 'Type', 'CHAR', false, null);
