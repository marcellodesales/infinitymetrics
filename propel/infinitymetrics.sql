...
-- 11/24/2008 2:37:11 PM
-- ----------------------------------
-- Alias: infinitymetricsm304 at localhost
...
CREATE DATABASE `infinitymetricsm304`
  CHARACTER SET `utf8`
  COLLATE `utf8_bin`;

USE `infinitymetricsm304`;
...
CREATE TABLE `custom_event` (
  ...
  `date`             date NOT NULL,
  `project_jn_name`  varchar(50) NOT NULL,
  `state`            enum ('O','R') NOT NULL DEFAULT 'O',
